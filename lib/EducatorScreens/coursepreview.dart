...
class CoursePreviewEdu extends StatefulWidget {
  const CoursePreviewEdu(
      {super.key,
      this.reviews,
      this.id,
      this.lessons,
  ...
  final thumbnail;
  @override
  State<CoursePreviewEdu> createState() => _CoursePreviewEduState();
}

class _CoursePreviewEduState extends State<CoursePreviewEdu> {
  bool info = true;
  int tab_index = 0;
  List<Widget> tabs = [];
  bool loading = false;
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              width: double.infinity,
                              padding:
                                  const EdgeInsets.only(top: 16.0, left: 24),
                              child: Text(
                                "Lessons",
                                style: TextStyle(fontSize: 20),
                              ),
