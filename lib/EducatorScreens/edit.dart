...
class EditProfileEdu extends StatefulWidget {
  const EditProfileEdu(
      {super.key,
      this.pic,
      this.name,
      this.dob,
  ...
  final is_educator;
  @override
  State<EditProfileEdu> createState() => _EditProfileEduState();
}

class _EditProfileEduState extends State<EditProfileEdu> {
  var file;
